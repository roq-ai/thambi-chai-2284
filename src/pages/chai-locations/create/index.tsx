...
import { createChaiLocation } from 'apiSdk/chai-locations';
...
function ChaiLocationCreatePage() {
  ...
  const handleSubmit = async (values: ChaiLocationInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createChaiLocation(values);
      resetForm();
