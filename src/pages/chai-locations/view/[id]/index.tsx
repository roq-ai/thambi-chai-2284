...
import { getChaiLocationById } from 'apiSdk/chai-locations';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Chai Location Detail View
          </Text>
          {hasAccess('chai_location', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/chai-locations/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('review', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/reviews/create?chai_location_id=${data?.id}`}>
